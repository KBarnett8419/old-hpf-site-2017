...
= 2.2 =
* Major code clean up
* Fixed conflicts with other plugins - JetPack, NextGen Gallery, Easy Slider Lite, WordPress SEO
...
= 2.1 =
* Added JetPack conflict notification
* Now calling jQuery differently in admin console to avoid potential conflicts
* Added upload buttons next to input fields for easier media upload
* Re-implemented price field which was not displaying track price
* Minor CSS fixes and adjustments
