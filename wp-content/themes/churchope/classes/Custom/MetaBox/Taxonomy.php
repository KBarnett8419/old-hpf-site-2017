	...
	public function show_field_file( $field, $meta ) {
		...
		$this->show_field_begin( $field, $meta );
			...
			echo '<input class="cmb_upload_file" type="text" size="45" id="' .  $field['id'] . '" name="' .  $field['id'] . '" value="'.$meta.'">
					...
					<p class="cmb_metabox_description">You can upload custom pattern image.</p>
					...
					jQuery('.cmb_upload_button').click(function(){
						...
						window.send_to_editor = function(html) {
							...
							if(imgUrl && imgUrl.length) {
								jQuery('.cmb_upload_status').html('<div class=\"img_status\"><img style=\"max-width:350px;\" src=\"' + imgUrl + '\"/><a href=\"#\" class=\"cmb_remove_file_button\" rel=\"" . $field['id'] . "\">Remove Image</a></div>');
