...
class Custom_MetaBox_Item_Category extends Custom_MetaBox_Item_Default
{
	...
	protected function addFields()
	{
		...
		$this->getMetaTaxInstance()->addSelect( SHORTNAME . Admin_Theme_Item_Slideshow::SLIDER, Admin_Theme_Element_Select_Slider::getSliders(), array('name' => 'Slider', 'std' => '', 'desc'=>'Select a slider for current category'));
