<?php
 ...
 class UniteBaseAdminClassRev extends UniteBaseClassRev{
		...
		public function __construct($mainFile,$t,$defaultView){
			...
			// self::addAction('custom_menu_order', "addAdminMenu");
			// self::addAction('menu_order', "addAdminMenu");
		...
		public static function addAdminMenu(){
			...
			foreach(self::$arrMenuPages as $menu){
				...
				add_menu_page( $title, $title, $role, self::$dir_plugin, array(self::$t, $pageFunctionName), get_template_directory_uri() . '/backend/img/i_slideshows.png', 8 );
			}
		}
