	...
	class RevOperations extends UniteElementsBaseRev{
		...
		public function getButtonClasses(){
			...
			$arrButtons = array(
				...
				"simple_button_link"=>"Churchope Simple Button",
				"simple_button_black"=>"Churchope Simple Dark Button",
				"churchope_button"=>"Churchope Simple Dark Button",
				"cycle_btn"=>"Churchope Slidshow button"
			);
