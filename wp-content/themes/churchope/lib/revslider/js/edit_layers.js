...
var UniteLayersRev = new function(){
	...
	t.insertButton = function(buttonClass,buttonText){
		...
		var html = "<a href='javascript:alert(\"click\");' class='tp-button "+buttonClass+" small'><span>"+buttonText+"</span></a>";
...
//======================================================	
	...
	var getNextTime = function(){
		...
		for (key in arrLayers){
			...
			if(layerTime > maxTime || layerTime == 0)
					maxTime = layerTime;
		}
				
		var outputTime;
		if(maxTime == undefined){
			outputTime = (jQuery("#image_url").val() == '') ? 0 : g_startTime;
		} else {
