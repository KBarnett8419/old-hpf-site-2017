var RevSliderAdmin = new function(){
		...
		this.initSlidesListView = function(sliderID){
			...
			jQuery("#button_new_slide, #button_new_slide_top").click(function(){
				var data = {sliderid:sliderID, url_image:''};
		...
		this.initEditSlideView = function(slideID){
			...
			/* CUSTOM */
			jQuery("#button_remove_image").click(function(){
				if(confirm("Do you really want to delete background?") == false)
					return(true);
			
				if(jQuery(this).hasClass("button-disabled"))
					return(false);
			
					jQuery("#divLayers").css("background-image","");
