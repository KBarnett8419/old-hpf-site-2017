	...
	<div class="edit_slide_wrapper">
		...
		<div class="editor_buttons_wrapper">
			...
			<a href="javascript:void(0)" id="button_change_image" class="button-primary margin_right10" style="margin-bottom:5px">Change Background</a>
			<a href="javascript:void(0)" id="button_remove_image" class="button-primary margin_right10" style="margin-bottom:5px">Remove Background</a>
